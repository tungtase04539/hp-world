export const meta = {
  ...
  description: 'Catalog 151 pano còn lại (4 heading tiết kiệm quota) theo quy chuẩn Hải Phòng',
  phases: [
    { title: 'Catalog', detail: '26 agent, mỗi agent 6 pano × 4 heading (0/90/180/270)' },
  ],
}
